<template>
  <div class="einl">
    ...
    <div>
      ...
      <hr />
      Die Stadt Vallaki (ausgesprochen vah-lah-key) liegt nahe am Ufer des Zarovitch-Sees und scheint ein sicherer Hafen gegen die Übel des Svalich-Waldes, wenn nicht sogar gegen Strahd selbst zu sein. Die Stadt liegt außerhalb der Sichtweite von Schloss Ravenloft und wirkt auf den ersten Blick nicht so deprimiert (oder unterdrückt) wie das weiter östlich gelegene Dorf Barovia. Charaktere, die sich in Vallaki aufhalten, erkennen jedoch schnell, dass es hier kein Glück gibt, sondern nur falsche Hoffnung - die Strahd selbst pflegt.<br><br>
      <table>
        <td class="text">
          <img id="bcos05-01" src="../assets/cos05-01.png" />
        </td>
        <td class="text">
          Vallaki wurde nicht lange nach der Eroberung des Tals durch die Armeen Strahds von einem Vorfahren des heutigen Bürgermeisters der Stadt, Baron Vargas Vallakovich, gegründet. Die Vallakoviches haben königliches Blut in ihren Adern und glauben seit langem, dass sie der Zarovich-Linie überlegen sind. Baron Vallakowitsch hat sich der Illusion hingegeben, dass Hoffnung und Glück der Schlüssel zu Vallakis Rettung sind. Wenn er alle in Vallaki glücklich machen kann, glaubt der Bürgermeister, dass die Stadt irgendwie Strahds Fesseln entkommen und in die vergessene Welt zurückkehren wird, aus der sie gekommen ist. Er veranstaltet ein Fest nach dem anderen, um die Stimmung der Stadtbewohner zu stärken, aber die meisten Vallakier halten diese Feste für sinnlose, bedeutungslose Angelegenheiten, die eher Strahds Zorn auf sich ziehen als Hoffnung für die Zukunft zu geben.<br><br>
        </td>
      </table>
      Beim letzten Fest ließ Baron Vallakovich die Bürger mit den abgetrennten Köpfen der Wölfe auf Spießern durch die Straßen ziehen. Seine nächste Veranstaltung, die der Bürgermeister als "Fest der brennenden Sonne" bezeichnet hat, wird bald beginnen (siehe Abschnitt "Besondere Ereignisse" am Ende dieses Kapitels). An den Dachvorsprüngen der Gebäude von Vallaki hängen noch wettergegerbte Girlanden von früheren Festen, und die Arbeiten an einer großen Korbsonne, die am Tag des Festes auf dem Stadtplatz in Flammen aufgehen soll, haben begonnen. In den Tagen vor dem Fest hat Baron Vallakovich damit begonnen, lokale Unzufriedene zu verhaften und sie in die Pranger zu stecken, damit seine Bemühungen nicht durch "diejenigen mit wenig Hoffnung oder Glauben" zunichte gemacht werden.<br><br>
      <div class="box">
          Es gibt kein Licht in den Augen der Männer, die sich von diesem Land ernähren. Sie sind so tot wie die Toten.
          <br />
      ...
      <div>
        ...
        <div class="flavor">
          Die Alte Svalichstraße schlängelt sich in ein Tal, das im Norden und Süden von dunklen, bedrohlichen Bergen bewacht wird. Der Wald zieht sich zurück und gibt den Blick frei auf eine mürrische Bergburg, die von einer Holzpalisade umgeben ist. Dichter Nebel drückt gegen diese Mauer, als ob er einen Weg ins Innere sucht, in der Hoffnung, die Stadt im Schlummer zu erwischen.<br><br>
        ...
        <h3>Stadttore</h3>
        <hr />
        Drei hohe Tore aus Eisenstangen führen in die Stadt:<br><br>
        <ul>
          <li>Das Nordtor wird manchmal auch als "Zarovich-Tor" oder "Tor zum See" bezeichnet, weil es zum Zarovich-See führt (Kapitel 2, Bereich L).</li>
          <li>Das Westtor wird als Sonnenuntergangstor bezeichnet, obwohl kein Mensch in Vallaki einen ungetrübten Sonnenuntergang gesehen hat. Einige verlassene Hütten säumen die Straße vor diesem Tor.</li>
          <li>Das Osttor ist auch als das Morgen-Tor oder, wie es einige Einheimische gerne nennen, als Trauer-Tor bekannt.</li>
        </ul><br>
        Schwere Eisenketten mit eisernen Vorhängeschlössern halten die Tore nachts geschlossen. Tagsüber sind die Tore zwar geschlossen, aber normalerweise nicht verschlossen.<br><br>
        Zwei Stadtwachen (LG-Männer und Frauen) stehen direkt vor jedem Tor. Anstelle von Speeren tragen sie Lanzen (Reichweite von 10 ft., 1d10 + 1 piercing damage bei einem Treffer). Diese Waffen sind lang genug, um Kreaturen durch die Gitterstäbe des Tores zu stechen. Die Wachen begrüßen alle Besucher mit Misstrauen, insbesondere diejenigen, die nachts ankommen. Wenn die Charaktere nachts ankommen, müssen einer oder mehrere von ihnen bei einer DC 20 Charisma (Persuasion) erfolgreich sein, um die Wachen zu überzeugen, das Tor aufzuschließen und sie eintreten zu lassen.<br><br>
        Wenn an einem der Tore Ärger ausbricht, schreien die Wachen dort "Zu den Waffen!". Ihre Rufe werden in ganz Vallaki widerhallen und die gesamte Stadt innerhalb von Minuten in Alarmbereitschaft versetzen. Vallaki hat vierundzwanzig menschliche Wachen, von denen die Hälfte jederzeit im Dienst ist (sechs stehen an den Toren Wache, sechs patrouillieren an den Mauern). Die Stadt kann auch eine Miliz von fünfzig körperlich gesunden, mit Knüppeln, Dolchen und Fackeln bewaffneten menschlichen Bürgern aufstellen.<br><br>
        <h3>Hausbewohner</h3>
        Wenn die Charaktere ein anderes Wohnhaus als das Herrenhaus des Bürgermeisters (Bereich N3) erkunden, würfeln Sie eine d20 und konsultieren Sie die folgende Tabelle, um den Bewohner des Hauses zu bestimmen.<br>
        <table>
          <tr>
            <th>d20</th>
            <th>Bewohner</th>
          ...
          <tr>
            <td>4 - 5</td>
            <td>2d4 Rattenschwärme</td>
          </tr>
          <tr>
            <td>6 - 18</td>
            <td>Vallakianische Stadtbewohner</td>
          </tr>
          <tr>
            <td>19 - 20</td>
            <td>Vallakianische Kultisten</td>
          </tr>
        </table><br>
        <p class="bold">Ratten</p>
        Ein von Ratten verseuchtes Haus scheint zunächst verlassen zu sein. Die Ratten sind Diener von Strahd und greifen an, wenn die Figuren das Innere des Hauses erkunden.<br><br>
        <p class="bold">Stadtbewohner</p>
        In einem Haus der Vallakian-Städter leben 1d4 Erwachsene (LG männliche und weibliche menschliche Bürger) und 1d8 - 1 Kinder (LG männliche und weibliche menschliche Nichtkämpfer). Jeder, der an der Tür lauscht, hört Geschwätz von innen. Die Stadtbewohner werden nicht freiwillig Fremde in ihre Häuser einladen, aber sie werden mit den Charakteren hinter verschlossenen Türen oder in ihren Vorräumen sprechen.<br><br>
        <p class="bold">Kultisten</p>
        In einem Kultort gibt es 2d4 vallakianische Erwachsene (LE männliche und weibliche Kultisten) und einen Kultfanatiker (LE männlich oder weiblich), der sie beim Gebet anleitet oder rituelle Opfer inszeniert. Diese Kultisten beten Teufel an und betrachten Lady Fiona Wachter (siehe Bereich N4) als ihre spirituelle Führerin.<br><br>
        <h3>Vallaki-Wissen</h3>
        <hr />
        Zusätzlich zu den Informationen, die allen Barovianern bekannt sind (siehe "Barovianisches Wissen" in Kapitel 2), kennen die Vallakianer die folgenden Teile der lokalen Überlieferungen:<br><br>
        <ul><li>
        Das Blue Water Inn (Gebiet N2) bietet Besuchern Essen, Wein und Unterkunft. Ein Fremder mit spitzen Ohren hält sich dort auf. Er kam aus einem fernen Land nach Barovia und fuhr auf einem Karnevalswagen in die Stadt.
        </li><li>
        Der Bürgermeister, Baron Vargas Vallakovich, hat verfügt, dass das Fest der brennenden Sonne in drei Tagen auf dem Stadtplatz (Gebiet N8) stattfinden soll. Das letzte Fest, das er als "Wolfshauptfest" bezeichnete, liegt weniger als eine Woche zurück.
        </li><li>
        Vallaki hat in den letzten Jahren mindestens ein Festival pro Woche erlebt. Einige Vallakianer glauben, dass die Festivals den Teufel Strahd in Schach halten. Andere glauben, dass sie keinerlei Schutz oder Nutzen bieten. Die meisten halten sie für eine düstere Angelegenheit.
        </li><li>
        Diejenigen, die schlecht über die Feste sprechen, werden vom Bürgermeister als mit dem Teufel Strahd im Bunde erklärt und verhaftet. Einige werden in die Pranger(Gebiet N8) gesteckt, während andere in das Herrenhaus des Bürgermeisters gebracht werden, damit der Baron sie von ihrem Übel befreien kann.
        </li><li>
        Der Gefolgsmann des Bürgermeisters, Izek Strazni, hat eine Geschichte der Gewalt und eine teuflische Missbildung: ein monströser Arm, mit dem er Feuer beschwören kann. Die Angst vor Izek hält die Feinde des Barons in Schach.
        </li><li>
        Niemand hasst den Bürgermeister mehr als Lady Fiona Wachter, die oft mit den Worten zitiert wird: "Lieber diene ich dem Teufel als einem Verrückten". Sie besitzt ein altes Haus in der Stadt (Gebiet N4), verlässt aber nur selten ihr Anwesen. Ihre beiden erwachsenen Söhne, Nikolai und Karl, sind örtliche Unruhestifter. Lady Wachter hat auch eine verrückte Tochter, die sie weggesperrt hält. Der Bürgermeister stellt Fiona oder ihre Nachkommen nicht zur Rede, weil er Angst vor Lady Wachter hat, deren Familie alte Verbindungen zu Strahd hat.
        </li><li>
        Auf dem Dachboden des Bürgermeisterhauses sind violette Lichtblitze zu sehen, die vom Dachboden des Bürgermeisters ausgehen.
        </li><li>
        Wölfe und Dire Wölfe streifen durch die Wälder und scheuen sich nicht, Reisende auf der alten Svalichstraße anzugreifen. Gut bewaffneten Gruppen von Jägern und Fallenstellern ist es gelungen, einige der Wölfe zu töten, aber es kommen immer mehr.
        </li><li>
        Es ist zu gefährlich, im Zarowitsch-See zu fischen (Kapitel 2, Bereich L) , aber die Bedrohung durch Strahds Wölfe hat Bluto Krogarow, den Stadtsäufer, nicht davon abgehalten, es zu versuchen. Er macht sich jeden Morgen auf den Weg und kehrt jeden Abend zurück, hat aber seit einiger Zeit keinen Fisch mehr gefangen.
        </li><li>
        In letzter Zeit wurde der verrückte Magier des Berges Baratok (Kapitel 2, Bereich M) nicht mehr gesehen. Die Leute sahen ihn am Nordufer des Zarowitsch-Sees herumschleichen und Blitze ins Wasser schießen, um die Fische zu töten. (Wenn die Figuren daran interessiert scheinen, diesen Zauberer zu treffen, empfehlen die Einheimischen, die Fischerboote am Südufer zu benutzen, um den See zu überqueren, da er kürzer und viel weniger gefährlich ist als ein Spaziergang um den See).
        </li><li>
        Es gibt ein Vistani-Camp im Wald südwestlich der Stadt (Gebiet N9). Die Vistani dort sind nicht sehr freundlich. Die Vistani sind in Vallaki nicht willkommen.
        </li><li>
        Westlich der Stadt befindet sich ein Geisterschloss (siehe Kapitel 7, "Argynvostholt"). Der Legende nach ist dort vor langer, langer Zeit ein Drache gestorben.
        </li><li>
      ...
      <div>
        ...
        <div class="flavor">
        Diese schiefe, jahrhundertealte Steinkirche hat einen gewölbten Kirchturm im hinteren Teil und Wände, die mit gesprungenen, farbigen Glasfenstern mit der Darstellung frommer Heiliger gesäumt sind. Ein Zaun aus Schmiedeeisen umschließt einen Garten mit Grabsteinen neben der Kirche. Ein dünner Nebel kriecht zwischen den Gräbern hindurch.
        </div><br>
        Diese Kirche ist dem Morninglord gewidmet und nach dem heiligen Andral benannt, dessen Gebeine einst unter dem Altar ruhten (siehe den Abschnitt "Gebeine des heiligen Andral").<br><br>
        Pater Lucian Petrovich (LG-Menschpriester) beaufsichtigt die Kirche und tut sein Bestes, um die Stimmung zu heben. Ihm zur Seite steht ein Waisen- und Altarjunge namens Yeska (LG-Mensch, männlich, nicht kämpfend). Ein kräftiger Bursche mit einer ständig gefurchten Stirn namens Milivoj (siehe unten) kümmert sich um den Boden und gräbt Gräber aus.<br><br>
        Nachts ist die Kirche voll von 2d6 + 6 verängstigten vallakischen Erwachsenen (LG männliche und weibliche menschliche Bürgerliche) und 2d6 gleichermaßen verängstigten vallakischen Kindern (LG männliche und weibliche menschliche Nichtkämpfer). Pater Lucian bietet seiner nächtlichen Gemeinde seine Gebete und das Versprechen des Schutzes des Heiligen Andral an. Unter der nächtlichen Herde von Pater Lucian befindet sich eine traurige alte Frau namens Willemina Rikalova. Ihr Sohn, der Schuhmacher Udo Lukowitsch, wurde inhaftiert, weil er sich gegen den Bürgermeister ausgesprochen hat (siehe Bereich N3m). Sie betet, dass ihr Sohn freigelassen wird.<br><br>
        <table>
          <td class="text">
            Milivoj (N männlicher menschlicher Bürgerlicher) wird selten ohne eine Schaufel gesehen, die er wie eine Keule schwingt. Ändern Sie seine Statistik wie folgt:<br><br>
            <ul><li>
          ...
          <td class="text">
            <img id="bcos05-03" src="../assets/cos05-03.png" />
          </td>
        </table>
        <p class="bold">Gebeine von St. Andral</p>
        Bis vor kurzem wurde die Kirche durch die Gebeine des heiligen Andral, die in einer Krypta unter dem Hauptaltar der Kirche versiegelt waren, vor den Verwüstungen Strahds geschützt. Aber jetzt ist die Kirche in Gefahr, weil jemand vor einigen Nächten in die Krypta eingebrochen ist und die Knochen gestohlen hat. Bis vor kurzem war Pater Lucian die einzige Person in Vallaki, die von den Knochen wusste, aber er erinnert sich, dass er sie vor über einem Monat Yeska gegenüber erwähnt hat, um den ängstlichen Jungen zu beruhigen. Nachdem die Knochen gestohlen worden waren, fragte Pater Lucian Yeska, ob er noch jemandem von den Knochen erzählt habe. Der Junge nickte, wollte aber keinen Namen preisgeben.<br><br>
        ...
        <br>
        <p class="bold">Hüter der Feder</p>
        Urwin Martikov (LG-Mensch) ist ein Werrabe (siehe Anhang D) und ein hochrangiges Mitglied der Hüter der Feder, eines Geheimbundes von Wereraben, der sich gegen Strahd stellt. Urwins Ehefrau und Geschäftspartnerin, Danika Dorakova (LG weiblicher Mensch), ist ebenfalls ein Werrabe, ebenso wie ihre beiden Söhne Brom und Bray. Die Jungen haben jeweils nur 7 Trefferpunkte und sind mit elf und neun Jahren zu jung, um effektive Kämpfer zu sein.<br><br>
        Zu jeder Zeit sind weitere 1d4 Werraben (Mitglieder der Hüter der Feder) im Gasthaus anwesend, entweder auf dem Dach in Rabenform oder in menschlicher Gestalt zusammengekauert. Diese Werraben sind loyale Freunde der Martikovs und helfen beim Schutz des Gasthauses.<br><br>
        Wenn die Figuren das Vertrauen der Werraben in Vallaki verdienen, werden die Hüter der Feder auf sie aufpassen. Wenn die Charaktere das nächste Mal in ernsthafte Schwierigkeiten geraten, können Sie eine Gruppe von 1d4 Werraben auftauchen lassen, um sie zu retten oder ihnen anderweitig zu helfen.<br><br>
        <p class="bold">Die Schicksale von Ravenloft</p>
        Wenn Ihre Kartenlesung zeigt, dass ein Schatz im Gasthaus versteckt ist, verraten die Wächter der Feder erst dann, wo der Schatz liegt, wenn sie wissen, dass die Figuren in der Lage sind, ihn zu beschützen. Um ihre Fähigkeiten zu testen, gibt Urwin den Charakteren die folgende Quest:<br><br>
        <div class="flavor">
        Urwin nimmt Sie zur Seite und hält seine Stimme tief. "Mein Weinvorrat ist fast aufgebraucht, und die nächste Lieferung ist überfällig. Ich gebe Euch, was Ihr sucht, wenn Ihr mir meinen Wein bringt. Der Weinberg und das Weingut befinden sich ein paar Meilen westlich von hier. Folgen Sie einfach der alten Svalichstraße und den Schildern."<br>
        </div><br>
        ...
        Die Doppeltüren, die in den Schankraum führen, können von innen verriegelt werden.<br><br>
        Auf Streben montiert und in Nischen hinter der Bar versteckt sind drei Weinfässer, die jeweils zu drei Vierteln leer sind. Zwei der Fässer enthalten Purple Grapemash Nr. 3 (ein billiger Wein), und das dritte enthält Red Dragon Crush (ein feiner Wein). In jedes Fass wird ein Messingzapfen gehämmert.<br><br>
        Danika Martikov kümmert sich normalerweise um die Bar, während ihr Mann in der Küche arbeitet (Bereich N2e). Ihre Jungen, Brom und Bray, huschen herum und kommen leicht unter die Füße.<br><br>
        Zwischen Morgengrauen und Mittag gibt es hier keine Gäste, und die Martikovs sind oben in ihren Schlafzimmern (Bereich N2o und N2p) oder auf dem Dachboden (Bereich N2q).<br><br>
        Von Mittag bis zur Abenddämmerung hat der Schankraum 2d4 örtliche Gäste (LG männliche und weibliche Bürgerliche). Von der Abenddämmerung bis Mitternacht sind 2d8 Vallakier hier. Darüber hinaus können eine oder mehrere der folgenden Personen während dieser Zeit anwesend sein.<br><br>
        <table>
          <td class="text">
            <img id="bcos05-05" src="../assets/cos05-05.png" />
          </td>
          <td class="text">
            <span class="bold">Wolfsjäger.</span> Szoldar Szoldarovich und Yevgeni Krushkin (N männliche Menschenspäher) sind einheimische Jäger, die das Blue Water Inn besuchen. Sie töten Wölfe und verkaufen das Fleisch als Lebensunterhalt, und ihre Arbeit ist gefährlich und blutig. Beide Männer sind grimmig und haben spukhafte Blicke in ihren Augen.<br><br>
            Die beiden sind mürrische Kerle, aber sie lassen sich selten eine Gelegenheit entgehen, Münzen zu verdienen. Wenn die Charaktere auf der Suche nach Führern oder Informationen über das Land Barovia sind, können Szoldar und Yevgeni ihnen helfen. Sie scheuen sich nicht, tagsüber über die Mauern von Vallaki hinauszugehen, und sie kennen die Wälder und das Tal gut. Sie sind bereit, für 5 gp pro Tag als Führer zu dienen oder im Austausch gegen kostenlose Getränke Wegbeschreibungen zu wichtigen Sehenswürdigkeiten zu geben. Sie halten es für töricht, "dieses verfluchte Reich" nachts zu bereisen, und werden dies nur tun, wenn ihre Bezahlung exorbitant ist (100 gp oder mehr).<br><br>
          </td>
        </table>
        In seltenen Fällen, in denen er etwas zu sagen hat, spricht Szoldar schroff, während Yevgeni seinem Freund gewöhnlich nicht so viele Worte nachplappert. Szoldar hat für jeden Wolf, den er getötet hat, eine Kerbe in seinem Bogen, während Yevgeni für jeden getöteten Wolf ein neues Muster in seinen Wolfsfellmantel legt.<br><br>
        <table>
          <td class="text">
            Beide Männer haben Familien, verbringen aber die meiste Zeit zusammen, entweder um ihre Sorgen zu ertränken oder um im Wald zu jagen. Die meisten der Wolfsköpfe, die die Wände der Taverne schmücken, sind das Ergebnis ihrer Handarbeit.<br><br>
            <span class="bold">Die Brüder Wachter.</span> Nikolai und Karl Wachter (N männliche Menschenadlige) sind Brüder von edler Geburt. Sie sind freche Trinker, die immer auf der Suche nach Ärger sind, obwohl sie klug genug sind, sich nicht mit gut bewaffneten Fremden zu prügeln. Ihre Mutter, Fiona Wachter (siehe Bereich N4), ist eine einflussreiche Persönlichkeit in der Stadt, aber ihre Söhne sprechen nie über sie. Sie hören lieber Geschichten über die erschütternden Abenteuer der Figuren oder darüber, wie die Figuren planen, Vallaki aus dem Wahnsinn des Bürgermeisters zu befreien.<br><br>
          </td>
          <td class="text">
            <img id="bcos05-06" src="../assets/cos05-06.png" />
            </td>
        </table>
        <span class="bold">Rictavio.</span> Der einzige Gast des Blue Water Inn ist derzeit ein bunt gekleideter Halb-Elfenbarde mit dem Namen Rictavio - eine falsche Identität, die der legendäre Vampirjäger Rudolph van Richten angenommen hat (siehe Anhang D). Er verwöhnt die Gastgeber mit Geschichten, die so ungeheuerlich sind, dass sie kaum zu glauben sind, und doch behauptet er, dass sie tatsächlich wahr sind. Rictavio behauptet, ein Karnevalszirkusdirektor aus einem fernen Land zu sein. Er wohnt seit fast einem Monat im Gasthaus und nutzt die Großzügigkeit und Gutmütigkeit von Urwin Martikov aus. Als er ankam, wurde er von einem Affen namens Piccolo begleitet. Der Affe war im Gasthaus nicht willkommen, also gab Rictavio ihn dem örtlichen Spielzeugmacher (siehe Bereich N7).<br><br>
